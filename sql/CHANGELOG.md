...
| 2026-08-05 | `2026-08-05-historial-valor-stock.sql` / `.down.sql` | Ambos | (ver commit "Agregar evolución del valor de stock") | ⏳ pendiente de correr | ⏳ pendiente de correr | El down borra toda la serie histórica de valor de stock guardada. El código funciona igual sin esta tabla (queda vacía) hasta que se corra el up en cada proyecto. |
