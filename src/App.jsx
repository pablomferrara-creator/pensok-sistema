  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      {tab==="libro"&&(()=>{
        ...
        // 5. Pagos de egresos (pagos_egreso con fecha real) — sin filtro de fechaInicio
        ...
        // 6. Egresos legacy (sin pagos_egreso) — todos, no solo pagador=Pensok
        const egresosConPagos2 = new Set(pagosEgreso.map(p=>p.egreso_id));
        egresos.filter(e=>!egresosConPagos2.has(e.id)&&(e.reembolsado||!(e.reembolso_pendiente))).forEach(e=>{
