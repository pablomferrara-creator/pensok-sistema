...
function ModuloCaja({ventas,egresos,toast}){
  ...
  // Esperado en cada bolsillo (solo lo que entra/sale del sistema)
  const esperadoCaja = vEfectivo - gEfectivo;
  const esperadoMP   = vMP;
  const esperadoBanco= vTransf;
    ...
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      {tab==="nuevo"&&(<>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:12}}>
            <Card>
              <ST>Saldos reales — ingresá lo que tenés</ST>
