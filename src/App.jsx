...
function useData(toast){
  ...
  async function cargar(){
    ...
    const{data:anioData}=await supabase.from("ventas").select("total,ganancia").gte("fecha",`${anioStr}-01-01`).lte("fecha",`${anioStr}-12-31`);
...
// ============================================================
function ModuloAnalisis({ventas,egresos,productos,vendedores,totalNosDeben,anioStats,onNavegar}){
  ...
  // Para año: usar anioStats de Supabase (sin limite)
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:12}}>
        <div onClick={()=>onNavegar("ingresos")} style={{cursor:"pointer",transition:"opacity .15s"}} onMouseEnter={e=>e.currentTarget.style.opacity=".8"} onMouseLeave={e=>e.currentTarget.style.opacity="1"}>
      ...
      {alertasStock.length>0&&(
        <div onClick={()=>onNavegar("productos")} style={{cursor:"pointer",transition:"opacity .15s"}} onMouseEnter={e=>e.currentTarget.style.opacity=".8"} onMouseLeave={e=>e.currentTarget.style.opacity="1"}>
      ...
      <div style={{minHeight:"100vh",background:G.fondo}}>
        ...
        <div style={{padding:"20px 22px",maxWidth:1200,margin:"0 auto"}}>
          {data.loading&&modulo!=="venta"
            ...
            :(<>
              {modulo==="analisis"       && <ModuloAnalisis       ventas={data.ventasConItems} egresos={data.egresos} productos={data.productos} vendedores={data.vendedores} totalNosDeben={data.totalNosDeben} anioStats={data.anioStats} onNavegar={setModulo}/>}
