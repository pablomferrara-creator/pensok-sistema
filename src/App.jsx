...
async function generarPDFPresupuesto({nroPresupuesto,version=1,clienteNombre="CONSUMIDOR FINAL",vendedor,tipoCliente="minorista",items}){
    ...
    const W=210,H=297;
    const azul=[20,53,107],azulClaro=[41,98,180],gris=[100,100,100],grisClar=[240,242,245],negro=[30,30,30],blanco=[255,255,255],verde=[0,150,100],celeste=[209,231,251];
    ...
    // Header celeste claro (ahorra tinta al imprimir; el logo mantiene su fondo azul propio)
...
function ModuloIngresos({ventas,vendedores,productos,clientes,onEditar,onEliminar,onEditarPago,onEliminarPago,totalVentas,filtroInicial="",filtrosPersistentes,onFiltrosChange,devoluciones=[],onDevolver,esAdmin=true}){
  ...
  async function imprimirTicket(v){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210,H=297;
    const azul=[50,50,50],azulClaro=[90,90,90],gris=[120,120,120],negro=[30,30,30],blanco=[255,255,255],rojo=[70,70,70],verde=[70,70,70],celeste=[209,231,251];
    const fmtP = n => '$ '+Math.round(n||0).toLocaleString('es-AR');

    // ── HEADER celeste claro (ahorra tinta al imprimir) ──
    doc.setFillColor(...celeste);
    doc.rect(0,0,W,38,'F');
    doc.setTextColor(...negro);
    doc.setFont('helvetica','bold');
    ...
    // ── FOOTER ──
    doc.setFillColor(...celeste); doc.rect(0,H-14,W,14,'F');
  ...
  async function imprimirRemito(v){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210,H=297;
    const oscuro=[80,80,80],grisM=[130,130,130],gris=[150,150,150],negro=[50,50,50],blanco=[255,255,255],celeste=[209,231,251];
    const grisClar=[240,242,245];
              ...
              <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6}}>
                ...
                {esAdmin&&(()=>{
                  ...
                  return <Btn small variant={yaPagado?"outlineAzul":"outline"} onClick={()=>{
                    ...
                    setNuevoPagoNotas("");
                  }}>{yaPagado?"💸 Pagos / Descuento":"+ Registrar pago"}</Btn>;
                })()}
                <div style={{display:"flex",gap:6}}>
...
function ModuloClientes({clientes,onGuardar,ventas}){
  ...
  async function generarDeudaPDF(){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210,H=297;
    const azul=[20,53,107],azulClaro=[41,98,180],gris=[100,100,100],negro=[30,30,30],blanco=[255,255,255],rojo=[200,50,50],verde=[0,150,100],celeste=[209,231,251];
    const LOGO = 'data:image/jpeg;base64,';
...
function ModuloProductos({productos,onGuardar,onEliminar,proveedores,ventas=[],esAdmin=true,toast}){
  ...
  async function generarListaPDF(tipo, productos_filtrados, filtrosInfo={}){
    ...
    const doc = new jsPDF({ orientation:'portrait', unit:'mm', format:'a4' });
    const W=210, H=297;
    const azul=[20,53,107], azulClaro=[41,98,180], gris=[100,100,100], grisClar=[240,242,245], negro=[30,30,30], blanco=[255,255,255], verde=[0,168,120], celeste=[209,231,251];
    ...
    function dibujarEncabezado(){
      // Fondo celeste claro (ahorra tinta al imprimir; el logo mantiene su fondo azul propio)
      doc.setFillColor(...celeste);
      doc.rect(0,0,W,38,'F');
      // Logo
...
function ModuloTraspasos({traspasos,pagosTraspaso,productos,onRegistrar,onPago,totalDeudaCamanio,localKey,toast}){
  ...
  async function imprimirRemitoTraspaso(t){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210,H=297;
    const oscuro=[80,80,80],gris=[150,150,150],negro=[50,50,50],blanco=[255,255,255],celeste=[209,231,251];
...
function ModuloControlStock({productos=[],conteosStock=[],onCrear,onAplicar,onEditarConteo,vendedores=[],vendedoresOtro=[],esAdmin=true,usuarioEmail=""}){
  ...
  async function imprimirPlanillaConteo(categoria,lista){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210, H=297;
    const azul=[20,53,107], azulClaro=[41,98,180], gris=[100,100,100], grisClar=[240,242,245], negro=[30,30,30], blanco=[255,255,255], celeste=[209,231,251];
    const LOGO_B64 = "data:image/jpeg;base64,";
