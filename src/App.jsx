...
function ModuloVenta({clientes,productos,onRegistrar,vendedores,esAdmin=true}){
  ...
  async function generarPresupuesto(){
    ...
    for(const it of items){
      ...
      if(filaPar){doc.setFillColor(...grisClar);doc.rect(14,y-5,W-28,8,'F');}
      filaPar=!filaPar;
      doc.setFont('helvetica','normal');
      doc.setFontSize(9);
      doc.setTextColor(...negro);
    ...
    if(descNum>0){
      doc.setTextColor(...gris);
      doc.text('Descuento ('+descNum+'%)',W-90,y);
      doc.setTextColor(...verde);
      doc.text('-'+fmtP(subtotalBruto*descNum/100),W-16,y,{align:'right'});
      y+=6;
    }
    ...
    doc.text(fmtP(total),W-16,y+6,{align:'right'});
    y+=18;
