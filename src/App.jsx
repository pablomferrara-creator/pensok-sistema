  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12}}>
        ...
        <MetricCard label="Resultado neto" value={fmt(resultado)} color={resultado>=0?G.verde:G.rojo} sub={`Gan. ${fmt(gMes)} − Egr. pagados ${fmt(eMesTotal)}${eMesPendiente>0?" (+ "+fmt(eMesPendiente)+" pend.)":""}`}/>
      </div>
