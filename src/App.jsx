  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:14}}>
        ...
        <Card style={{cursor:"pointer",transition:"all .15s"}} onClick={()=>{console.log("click pareto"); setParetoOpen(true);}} onMouseEnter={e=>e.currentTarget.style.borderColor=G.verde} onMouseLeave={e=>e.currentTarget.style.borderColor=G.borde}>
