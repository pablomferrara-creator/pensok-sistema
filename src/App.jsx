...
function ModuloAbastecimiento({productos,abastecimiento,onRegistrar,vendedores,proveedores,onEditar,onEliminar}){
  ...
  async function registrar(){
    ...
    await onRegistrar({fecha:hoy(),producto_id:prodSelec.id,nombre:prodSelec.nombre,cantidad:parseInt(cantidad),costo_unit:prodSelec.costo||0,proveedor,metodo_pago:metodo||METODOS_PAGO[0],responsable:resp||"Pensok",notas});
    setLoading(false);setOk(true);
