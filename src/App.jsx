...
function ModuloIngresos({ventas,vendedores,productos,clientes,onEditar,onEliminar,totalVentas,filtroInicial="",esAdmin=true}){
  ...
  async function imprimirTicket(v){
    ...
    const doc = new jsPDF({orientation:'portrait',unit:'mm',format:'a4'});
    const W=210,H=297;
    const azul=[20,53,107],azulClaro=[41,98,180],gris=[100,100,100],negro=[30,30,30],blanco=[255,255,255],rojo=[180,30,30];
    const LOGO = 'data:image/jpeg;base64,';
    const fmtP = n => '$ '+Math.round(n||0).toLocaleString('es-AR');
    ...
    doc.setFont('helvetica','bold');
    doc.setFontSize(20);
    doc.text('PENSOK',46,16);
    doc.setFont('helvetica','normal');
    doc.setFontSize(8.5);
    doc.text('DOMOKIP SAS',46,22);
    doc.text('Gelves 1126, B1629 Pilar, Buenos Aires',46,27);
    doc.text('CUIT: 30-71686952-7',46,32);
    doc.text('Tel: 11-7064-5115  ·  @pensok.piletas',46,37);
    // Badge NO VALIDO
    doc.setFillColor(...rojo);
    doc.roundedRect(W-72,8,66,14,2,2,'F');
    doc.setFont('helvetica','bold');
    ...
    doc.setTextColor(...blanco);
    doc.text('COMPROBANTE INTERNO',W-39,14,{align:'center'});
    doc.text('NO VÁLIDO COMO FACTURA',W-39,20,{align:'center'});
    ...
    doc.setFontSize(9);
    doc.setTextColor(...azul);
    doc.text('DATOS DE LA OPERACIÓN',14,y);
    y+=5;
    doc.setDrawColor(...azulClaro);
    doc.setLineWidth(0.3);
    doc.line(14,y,W-14,y);
    y+=6;
    const infoLeft=[[`N° Comprobante:`,v.nro_factura||'—'],[`Fecha:`,v.fecha||'—'],[`Hora:`,v.hora||'—']];
    const infoRight=[[`Vendedor:`,v.vendedor||'—'],[`Cliente:`,v.cliente_nombre||'CONSUMIDOR FINAL'],[`Método pago:`,v.metodo_pago||'—']];
    doc.setFont('helvetica','normal');
    doc.setFontSize(9);
    infoLeft.forEach((row,i)=>{
      doc.setTextColor(...gris); doc.text(row[0],14,y+i*6);
      doc.setFont('helvetica','bold'); doc.setTextColor(...negro); doc.text(row[1],55,y+i*6);
      doc.setFont('helvetica','normal');
    });
    infoRight.forEach((row,i)=>{
      doc.setTextColor(...gris); doc.text(row[0],W/2,y+i*6);
      doc.setFont('helvetica','bold'); doc.setTextColor(...negro); doc.text(row[1],W/2+30,y+i*6);
      doc.setFont('helvetica','normal');
    });
    y+=22;
    ...
    doc.setTextColor(...negro);
    doc.setFont('helvetica','bold');
    doc.text(fmtP(subtotal),W-16,y,{align:'right'});
    y+=7;
    if(desc>0){
      doc.setFont('helvetica','normal');
      doc.setTextColor(...gris);
      ...
      doc.setFont('helvetica','bold');
      doc.text('-'+fmtP(subtotal*desc/100),W-16,y,{align:'right'});
      y+=7;
    }
    // Total box
    doc.setFillColor(...azul);
    doc.rect(W-80,y-2,66,12,'F');
    doc.setFont('helvetica','bold');
    doc.setFontSize(13);
    doc.setTextColor(...blanco);
    doc.text('TOTAL',W-77,y+6);
    doc.text(fmtP(v.total),W-16,y+6,{align:'right'});
    y+=18;

    // Estado cobro/entrega
    doc.setFont('helvetica','normal');
    doc.setFontSize(9);
    doc.setTextColor(...gris);
    doc.text(`Estado: ${v.cobrado?'✓ Cobrado':'Pendiente de cobro'}  ·  ${v.entregado?'✓ Entregado':'Pendiente de entrega'}`,14,y);
    y+=14;

    // ── QR WHATSAPP ──
    const qrUrl='https://wa.me/5491170645115';
    // Generate QR as canvas then add to PDF
    const qrDiv=document.createElement('div');
    document.body.appendChild(qrDiv);
    try{
      new window.QRCode(qrDiv,{text:qrUrl,width:80,height:80,colorDark:"#14356B",colorLight:"#ffffff"});
      await new Promise(r=>setTimeout(r,300));
      const qrCanvas=qrDiv.querySelector('canvas');
      if(qrCanvas){
        const qrImg=qrCanvas.toDataURL('image/png');
        try{doc.addImage(qrImg,'PNG',14,y,25,25);}catch(e){}
        doc.setFont('helvetica','normal');
        doc.setFontSize(8);
        doc.setTextColor(...gris);
        doc.text('Escanea para chatear',41,y+8);
        doc.text('WhatsApp: 11-7064-5115',41,y+16);
        doc.text('Instagram: @pensok.piletas',41,y+21);
      }
    }catch(err){}
    ...
    doc.setFontSize(7.5);
    doc.setTextColor(...blanco);
    doc.text('DOMOKIP SAS — CUIT 30-71686952-7 — Gelves 1126, Pilar, Buenos Aires',14,H-8);
    doc.text(v.nro_factura||'',W-14,H-8,{align:'right'});
    doc.setFontSize(7);
    doc.setTextColor(180,200,255);
    doc.text('Comprobante interno. No válido como factura.',W/2,H-3,{align:'center'});
          ...
          <Card key={v.id} style={{padding:"12px 18px",cursor:esAdmin?undefined:"pointer"}} onClick={!esAdmin?()=>abrirQuickEdit(v):undefined}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:8}}>
              ...
              <div style={{display:"flex",gap:8,alignItems:"center"}}>
                ...
                <Btn small variant="secondary" disabled={genTicket===v.id} onClick={()=>imprimirTicket(v)}>🖨 Ticket</Btn>
              </div>
            </div>
            {v.items?.length>0&&(
